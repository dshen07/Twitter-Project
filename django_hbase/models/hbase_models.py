"""
HBaseModel is similar to Django ORM models.
HBaseField is similar to Django ORM fields.
We define a model class with class attributes and the field instances.
When we create an instance of the model class, we will check the values
against the field instances. And we will do necessary serialization.
Then we call save() to save the instance of the model class.
"""
...
class HBaseModel:
    ...
    def get_or_create(cls, **kwargs):
        ...
        table = cls.get_table()
        row = table.row(row_key)
        # no row with corresponding row_key
